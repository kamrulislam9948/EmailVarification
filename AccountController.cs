    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return Ok(new { Username = user.UserName, message= "A confirmation link sent to your mail. Please confirm the mail address" });
                }
        ...
        private async Task<ActionResult> SendAsync(string message, string email)
        {
            try
            {
                ...
                mail.From.Add(new MailboxAddress("Antoinette Kertzmann", "antoinette.kertzmann@ethereal.email"));
                mail.Sender = new MailboxAddress("Antoinette Kertzmann", "antoinette.kertzmann@ethereal.email");
                ...
                await smtp.AuthenticateAsync("antoinette.kertzmann@ethereal.email", "TfGQjzEaPTJ7du7dhA", CancellationToken.None);
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            if (user != null && await userManager.CheckPasswordAsync(user, model.Password))
            {
                ...
                var signingKey = Encoding.UTF8.GetBytes(config["Jwt:SigningKey"] ?? "NET-BRIDGE CLIENT-PORTAL");
